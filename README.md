...
Follow the steps below to get started with Kahawa, or get it up and running right from
...
Once Kahawa is running locally, you can connect it with **Polkadot-JS Apps** front-end
